...
// Import A2A Service for agent-to-agent communication
let A2AService;
try {
  A2AService = require('./a2aService.js');
} catch (error) {
  logger.debug('A2A Service not available during orchestration service load');
}
